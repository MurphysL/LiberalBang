...
import com.example.lenovo.murphysl.PoiDetailActivity;
        ...
        q.findObjects(MapActivity.this, new FindListener<QiangYu>() {
            ...
            public void onSuccess(List<QiangYu> list) {
                ...
                while (i.hasNext()) {
                    ...
                    final String geoDetail= voiceBean.getGeo();
                    final String keyWord = voiceBean.getKeyWord();
                    ...
                    q.getObject(MapActivity.this, id, new GetListener<UserBean>() {
                        ...
                        public void onSuccess(UserBean userBean) {
                            ...
                            bundle.putString("geo" , geoDetail);

                            BitmapDescriptor bitmap = null;
                            if(keyWord != null && keyWord.equals(UserModel.getInstance().getUser().getHobby())){
                                bitmap = BitmapDescriptorFactory.fromResource(R.drawable.friend_mark);
                            }else{
                                bitmap = BitmapDescriptorFactory.fromResource(R.drawable.stranger_mark);
                            }
                            //构建Marker图标
    ...
    private class MyMomentMarkerClickListener implements BaiduMap.OnMarkerClickListener {
        ...
        public boolean onMarkerClick(Marker marker) {
            ...
            if (marker != null) {
                ...
                LatLng geo = b.getParcelable("loc");
                BmobFile file = (BmobFile) b.getSerializable("fileUrl");
                String content = b.getString("content");
                String geoDetail = b.getString("geo");
                int love = b.getInt("love");
                UserBean autor = (UserBean) b.getSerializable("autor");
                ...
                popupText.setText("用户：" + autor.getUsername() +  "\n求助信息：" + content
                        +"\n具体位置：" + geoDetail + "(" + (int)geo.longitude +","+ (int)geo.latitude + ")");
        ...
        if (res != null && res.infoList != null && res.infoList.size() > 0) {
            for (int i = 0; i < res.infoList.size(); i++) {
                ...
                //if (other > mine - TimeUtil.ONE_DAY) {
                    ...
                    Double distance = DistanceUtil.getDistance(pt, res.infoList.get(i).pt);
                    if(distance <= 20){
                        NotificationManager manager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
                        Notification notification = new Notification.Builder(MapActivity.this)
                                .setSmallIcon(R.mipmap.logo)
                                .setContentInfo("帮助您的人已在附近" + distance.intValue() + "米")
                                .setContentTitle("帮助信息").getNotification();
                        manager.notify(1 , notification);
                    }

                    des.putDouble("radar_distance", distance);
    ...
    private class MyRadarMarkerClickListener implements BaiduMap.OnMarkerClickListener {
        ...
        public boolean onMarkerClick(Marker marker) {
            ...
            if (marker != null) {
                ...
                around_distance = (int) marker.getExtraInfo().getDouble("radar_distance");

                EventBus.getDefault().post(new UserEvent(around_id, around_name, around_hobby, around_distance));
