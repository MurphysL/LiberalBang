...
public class FacePPDecet {
    ...
    public static void createPerson(final String name , final CallBack callBack){
        new Thread(new Runnable() {
            @Override
            public void run() {
                ...
                try {
                    ...
                    parameters.setPersonName(name).setFaceId(name);
                    JSONObject jsonObject1 = requests.personAddFace();
    ...
    public static void addFace(final String name , final Bitmap bm , final CallBack callBack){
        new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    ...
                    // person/add_face
                    PostParameters parameters = new PostParameters();
                    //parameters.setPersonName(name).setFaceId(name).set;
                    JSONObject jsonObject = requests.personAddFace();
