...
import com.example.lenovo.murphysl.bean.AgreeAddFriendMessage;
...
public class NewFriendAdapter extends BaseRecyclerAdapter<NewFriend> {
    ...
    public NewFriendAdapter(Context context, MyMutlipleItem<NewFriend> items, Collection<NewFriend> datas) {
        super(context,items,datas);
    }

    @Override
    public void bindView(final BaseRecyclerHolder holder, final NewFriend add, int position) {
        holder.setImageView(add == null ? null : add.getAvatar(), R.mipmap.fortress, R.id.iv_recent_avatar);
